    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <p>Aprender a programar significa aprender a resolver problemas usando código.</p>
                <p> La habilidad que se necesita adquirir es pensar con mucha precisión en cómo resolver el problema y dividirlo en pasos que sean tan simples que una computadora pueda ejecutarlos.</p>
                <p>Todo el mundo comete errores al programar y encontrar errores en los programas consume una gran parte de la jornada laboral de un programador.</p>
                <p>Si es neceario al principio escribe comentarios que te ayuden a entender lo que has hecho.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 destacado">
                <h3>Ejercicios Fundamentos Programación</h3>
                <h4 class="mt-4">Básicos</h4>
                <ol class="mt-4">
                    <li class="mt-3">Escribe un programa que imprima "Hola mundo" por la pantalla. 
                    <a href="https://www.programarya.com/Cursos/Java/Salida-de-datos" target="_blank" rel="noopener noreferrer">Ayuda<span class="fas fa-external-link-alt"></span></a>
                    </li>
                    <li class="mt-3">Escribe un programa que le pregunte al usuario su nombre y lo salude con su nombre. 
